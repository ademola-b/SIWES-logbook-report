...
List<EntryDateResponse> entryDateResponseFromJson(String str) =>
    List<EntryDateResponse>.from(
        json.decode(str).map((x) => EntryDateResponse.fromJson(x)));

String entryDateResponseToJson(List<EntryDateResponse> data) =>
