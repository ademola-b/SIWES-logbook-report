...
List<StudentDetailResponse> studentDetailResponseFromJson(String str) => List<StudentDetailResponse>.from(json.decode(str).map((x) => StudentDetailResponse.fromJson(x)));

String studentDetailResponseToJson(List<StudentDetailResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
