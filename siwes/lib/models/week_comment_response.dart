...
WeekCommentResponse weekCommentResponseFromJson(String str) =>
    WeekCommentResponse.fromJson(json.decode(str));

String weekCommentResponseToJson(WeekCommentResponse data) =>
...
class WeekCommentResponse {
  ...
  factory WeekCommentResponse.fromJson(Map<String, dynamic> json) =>
      WeekCommentResponse(
        id: json["id"],
